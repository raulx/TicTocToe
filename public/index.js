...
//     choosen = 'x';
//     let crossColor = choosen==='x'?'#ff4d4d':'#f9c831';
//     dynamicCross.style.setProperty('--dynamic-cross',crossColor)
// })
// circleBox.addEventListener('click',()=>{
//     choosen = 'o';
//     let circleColor = choosen==='o'?'#ff4d4d':'#f9c831';
//     dynamicCircle.style.setProperty('--dynamic-circle',circleColor)
// })
